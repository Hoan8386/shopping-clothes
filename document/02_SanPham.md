...
| `hinhAnhChinh` | String(255)   | Tên file ảnh chính (lưu trên Cloudinary) |
...
| `file`          | File    | Không    | Ảnh sản phẩm (upload lên Cloudinary) |

**Response:** `201 Created` — Trả về `ResSanPhamDTO`

> **Lưu ý:** Ảnh sản phẩm được upload lên Cloudinary. URL ảnh có thể truy cập qua `GET {secure_url_cloudinary}`.
