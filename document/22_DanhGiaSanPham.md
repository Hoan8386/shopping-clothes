...
> Quản lý đánh giá sản phẩm — Khách hàng đánh giá từng sản phẩm trong đơn hàng sau khi đã nhận hàng, hỗ trợ upload ảnh lên Cloudinary.
...
| `hinhAnh`        | String(255)    | URL ảnh đánh giá (upload lên Cloudinary)                        |
...
| `file`             | File    | Không    | Ảnh đánh giá (upload lên Cloudinary)      |
...
| `file`   | File    | Không    | Ảnh mới (upload lên Cloudinary) |
